...
| Range Based            | Лайки, Комментарии, Медиа           |
| Key Based              | Подписка                            |
...
Ожидается быстрый рост числа комментариев, лайков и медиа, кажется стоит выбрать Range Based относительно post_id, к которым они принадлежат.
Подписки все таки больше соотносятся с каким-то конкретным профилем, поэтому Key Based.
```
